...
class telegraf (
  ...
  $inputs_merge_strategy         = $telegraf::params::inputs_merge_strategy,
  $input_plugins                 = $telegraf::params::input_plugins,
  $input_plugins_merge_strategy  = $telegraf::params::input_plugins_merge_strategy,
  $outputs                       = $telegraf::params::outputs,
  $outputs_merge_strategy        = $telegraf::params::outputs_merge_strategy,
  $output_plugins                = $telegraf::params::output_plugins,
  $output_plugins_merge_strategy = $telegraf::params::output_plugins_merge_strategy,
...
) inherits ::telegraf::params
{
  ...
  $_inputs = lookup({
    ...
    merge         => $inputs_merge_strategy,
  })
  $_outputs = lookup({
    name          => 'telegraf::outputs',
    default_value => $outputs,
    merge         => $outputs_merge_strategy,
  })
  $_input_plugins = lookup({
    name          => 'telegraf::input_plugins',
    default_value => $input_plugins,
    merge         => $input_plugins_merge_strategy,
  })
  $_output_plugins = lookup({
    name          => 'telegraf::output_plugins',
    default_value => $output_plugins,
    merge         => $output_plugins_merge_strategy,
  })
